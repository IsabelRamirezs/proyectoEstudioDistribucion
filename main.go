...
import (
	"github.com/IsabelRamirezs/proyectoEstudioDistribucion/calculadora"
	"github.com/IsabelRamirezs/proyectoEstudioDistribucion/gestorArchivos"
	"fmt"
	"sync"
	"time"
)
...
func main() {
	...
	fmt.Println("-> Ejecutando versión")
	coleccionOperaciones := gestorArchivos.CargarArchivo(instancia)
	tiempoInicial := time.Now()
